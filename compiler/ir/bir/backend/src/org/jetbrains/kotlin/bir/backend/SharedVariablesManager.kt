...
interface SharedVariablesManager {
    fun transformSharedVariable(variable: BirVariable)

    fun defineSharedValue(originalDeclaration: BirVariable, sharedVariableDeclaration: BirVariable): BirStatement

    fun transformGetSharedValue(sharedVariable: BirValueDeclaration, originalGet: BirGetValue): BirExpression

    fun transformSetSharedValue(sharedVariable: BirValueDeclaration, originalSet: BirSetValue): BirExpression
}